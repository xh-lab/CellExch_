...
#l_embedding = torch.load('/home/jby2/XH/CellExch/l_embedding.pt')
#r_embedding = torch.load('/home/jby2/XH/CellExch/r_embedding.pt')
#print(l_embedding)
#print(r_embedding)
...
# define similar model as the CellDialog.py
