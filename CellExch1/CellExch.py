...
proteinFeature_L = pd.read_csv("/home/jby2/XH/CellExch/dataset3/ligand_res_fea.csv", header=None, index_col=None)
proteinFeature_R = pd.read_csv("/home/jby2/XH/CellExch/dataset3/receptor_res_fea.csv", header=None, index_col=None)
interaction = pd.read_csv("/home/jby2/XH/CellExch/dataset3/ligand-receptor-interaction.csv", header=None, index_col=None, skiprows=1)  
...
cancer = r'/home/jby2/XH/CellExch/CellExch1/dataset3'  # File directory for cancer species
...
for fold, (train_index, test_index) in enumerate(kf.split(sample, label)):
    ...
    with torch.no_grad():
        ...
        with open("/home/jby2/XH/CellExch/CellExch1/dataset3/five-fold-cross-validation/value_of_" + str(fold) + ".txt", mode="a") as f:
        ...
        directory = '/home/jby2/XH/CellExch/CellExch1/dataset3/five-fold-cross-validation/roc/'
        ...
        df = pd.DataFrame(data)
        directory = '/home/jby2/XH/CellExch/CellExch1/dataset3/five-fold-cross-validation/prc/'
        #if not os.path.exists(directory):
            # create directory
            #os.makedirs(directory)
        df.to_csv(directory + str(fold) + ".csv", index=False)
        ...
        # save model
        torch.save(model.state_dict(), '/home/jby2/XH/CellExch/CellExch1/dataset3/test_model' + str(fold) + '.pth')
...
os.rename('/home/jby2/XH/CellExch/CellExch1/dataset3/test_model' + str(default_model) + '.pth', '/home/jby2/XH/CellExch/CellExch1/dataset3/final_model.pth')
...
with open("/home/jby2/XH/CellExch/CellExch1/dataset3/five-fold-cross-validation/mean_value_of_five-fold_cross-validation.txt", mode="a") as f:
    f.write("precision:{}\n".format(precision_kt))
    f.write("recall:{}\n".format(recall_kt))
    f.write("acc:{}\n".format(acc_kt))
    f.write("f1:{}\n".format(f1_kt))
